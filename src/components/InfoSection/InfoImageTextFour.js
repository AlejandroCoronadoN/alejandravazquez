      ...
      <section className="section discover-area overflow-hidden ptb_100">
        <div className="container">
          ...
          <div className="col-12 col-lg-6 order-1 order-lg-2">
            ...
            <h2 className="pb-4 pb-sm-0">{  contentDetails.InfoTextImageFour.heading}</h2>
            <p className="d-none d-sm-block pt-3 pb-4">{  contentDetails.InfoTextImageFour.headingText}</p>
            {/* Check List */}
            <ul className="check-list">
              {contentDetails.InfoTextImageFour.discoverData.map((item, idx) => {
                return(
                  <div key={`do_${idx}`}>
                    <li className="py-2">
                      {/* List Box */}
