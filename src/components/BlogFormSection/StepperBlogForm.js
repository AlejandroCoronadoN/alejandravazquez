...
import BlogForm1 from "./Forms/BlogForm1";
import BlogForm2 from "./Forms/BlogForm2";
import BlogForm3 from "./Forms/BlogForm3";
import BlogForm4 from "./Forms/BlogForm4";
import BlogForm5 from "./Forms/BlogForm5";
import BlogForm6 from "./Forms/BlogForm6";
import BlogForm7 from "./Forms/BlogForm7";
...
const StepperBlogForm = props => {
    const [cardStatus, setCardStatus] = useState(true);
    const [cardMessage, setCardMessage] = useState("");
    const [blogPath,setblogPath]   = useState("ERROR: NO MODIFIED");
    ...
    const capture = async () => {
        const date = new Date();
        const formData = {
        collectionName: 'Blogs',  //This Variable needs to be chnaged for each component and Firebase Collection
        loading: loading,
        ...
        console.log(' StepperBlog/capture ->formData:', formData);
        try {
...
export default StepperBlogForm;
