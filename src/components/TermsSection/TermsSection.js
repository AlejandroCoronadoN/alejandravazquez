      ...
      <section className="section faq-area ptb_100">
        <div className="container">
          ...
          <div className="col-12 col-md-10 col-lg-7">
            ...
            <h2 className="">{contentDetails.TermsSectionContent.headingTwo}</h2>
            <p className="d-none d-sm-block mt-4">{contentDetails.TermsSectionContent.headingText}</p>
            <p className="d-block d-sm-none mt-4">{contentDetails.TermsSectionContent.headingTexttwo}</p>
            </div>
          </div>
          </div>
          <div className="row justify-content-center">
          <div className="col-12">
            ...
            <div className="accordion" id="sApp-accordion">
              ...
              <div className="col-12 col-md-10 col-lg-8">
                ...
                {contentDetails.TermsSectionContent.faqData.map((item, idx) => {
                  return(
