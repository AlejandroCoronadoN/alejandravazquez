      ...
      <section className="section service-area bg-gray overflow-hidden ptb_100">
        <div className="container">
          ...
          <div className="col-12 col-lg-6 order-2 order-lg-1">
            ...
            <h2 className="text-capitalize mb-4">{contentDetails.InfoTextImageTwo.heading}</h2>
            {/* Service List */}
            <ul className="service-list">
              {contentDetails.InfoTextImageTwo.serviceData.map((item, idx) => {
                return(
                  <div key={`so_${idx}`}>
                    {/* Single Service */}
            ...
            <div className="section-heading text-center top-buffer-5">
              <a href="/asesoria" className="landing-button btn mt-1 ">{contentDetails.InfoTextImageTwo.button}</a> 
            </div>
            </div>
          ...
          <div className="col-12 col-lg-4 order-1 order-lg-2 d-none d-lg-block">
            ...
            <img src={contentDetails.InfoTextImageTwo.thumbOne} alt="" />
            </div>
          </div>
          </div>
        </div>
...
export default InfoTextImageTwo;