        ...
        <div className="container">
          ...
          <div className="col-12 col-lg-6 order-2 order-lg-1">
            ...
            <div className="service-thumb discover-thumb mx-auto pt-5 pt-lg-0">
              <img src={  contentDetails.InfoImageTextOne.thumbOne} alt="" />
            </div>
          </div>
          <div className="col-12 col-lg-6 order-1 order-lg-2">
            {/* Discover Text */}
            <div className="discover-text pt-4 pt-lg-0">
            <h2 className="pb-4 pb-sm-0">{  contentDetails.InfoImageTextOne.heading}</h2>
            <p className="d-none d-sm-block pt-3 pb-4">{  contentDetails.InfoImageTextOne.headingText}</p>
            {/* Check List */}
            <ul className="check-list">
              {contentDetails.InfoImageTextOne.discoverData.map((item, idx) => {
                return(
                  <div key={`do_${idx}`}>
                    <li className="py-2">
                      {/* List Box */}
            ...
            <div className="section-heading top-buffer-5">
              <a href="/asesoria" className="landing-button btn mt-1 ">{contentDetails.InfoImageTextOne.button}</a>
            </div>
...
export default InfoImageTextOne;